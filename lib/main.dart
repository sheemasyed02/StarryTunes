...
final Map<String, List<Map<String, String>>> globalPlaylists = {
  ...
  'K-pop': [
    {'title': 'Apt – Rosé', 'url': 'assets/Kpop/apt.mp3'},
    {'title': 'Antifragile – LE SSERAFIM', 'url': 'assets/Kpop/antifragile.mp3'},
    {'title': 'Shut Down – BLACKPINK', 'url': 'assets/Kpop/shut down.mp3'},
    {'title': 'Zoom – Jessi', 'url': 'assets/Kpop/zoom.mp3'},
    {'title': 'Boombayah – BLACKPINK', 'url': 'assets/Kpop/boombayah.mp3'},
    {'title': 'What Is Love? – TWICE', 'url': 'assets/Kpop/what is love.mp3'},
    {'title': 'Money – Lisa', 'url': 'assets/Kpop/money.mp3'},
    {'title': 'Ddu-Du Ddu-Du – BLACKPINK', 'url': 'assets/Kpop/ddu du ddu du.mp3'},
    {'title': 'Loser = Lover – TXT (Tomorrow X Together)', 'url': 'assets/Kpop/loser = lover.mp3'},
    {'title': 'As If It\'s Your Last – BLACKPINK', 'url': 'assets/Kpop/As if it\'s last.mp3'},
    {'title': 'Hype Boy – NewJeans', 'url': 'assets/Kpop/Hype boy.mp3'},
    {'title': 'Psycho – Red Velvet', 'url': 'assets/Kpop/Psycho.mp3'},
    {'title': 'Whistle – BLACKPINK', 'url': 'assets/Kpop/Whistle.mp3'},
    {'title': 'Playing With Fire – BLACKPINK', 'url': 'assets/Kpop/Playing with fire.mp3'},
    {'title': 'Kiss and Make Up – Dua Lipa & BLACKPINK', 'url': 'assets/Kpop/Kiss and makeup.mp3'},
    {'title': 'OMG – NewJeans', 'url': 'assets/Kpop/OMG.mp3'},
    {'title': 'Queencard – (G)I-DLE', 'url': 'assets/Kpop/QueenCard.mp3'},
    {'title': 'BIBI Vengeance – BIBI', 'url': 'assets/Kpop/Bibi Vegenance.mp3'},
    {'title': 'New Woman – Lisa & Rosalía', 'url': 'assets/Kpop/New Women.mp3'},
    {'title': 'Typa Girl – BLACKPINK', 'url': 'assets/Kpop/Typa girl.mp3'},
    {'title': 'Pretty Savage – BLACKPINK', 'url': 'assets/Kpop/Pretty Savage.mp3'},
    {'title': 'Ditto – NewJeans', 'url': 'assets/Kpop/Ditto.mp3'},
    {'title': 'I AM – IVE', 'url': 'assets/Kpop/I am.mp3'},
    {'title': 'Tomboy – (G)I-DLE', 'url': 'assets/Kpop/Tomboy.mp3'},
    {'title': 'After LIKE – IVE', 'url': 'assets/Kpop/After like.mp3'},
  ],
  'Sad': [
    {'title': 'Line Without a Hook – Ricky Montgomery', 'url': 'assets/Sad/Line without a hook.mp3'},
    {'title': 'No One Noticed – (indie artist)', 'url': 'assets/Sad/No one noticed.mp3'},
    {'title': 'Jhol – Maanu', 'url': 'assets/Sad/Jhol.mp3'},
    {'title': 'Afsos – Anuv Jain', 'url': 'assets/Sad/Afsos.mp3'},
    {'title': 'Paro – Aaditya Rikhari', 'url': 'assets/Sad/Paaro.mp3'},
    {'title': 'Jo Tum Mere Ho – Anuv Jain', 'url': 'assets/Sad/jo tum mere ho.mp3'},
    {'title': 'Summertime Sadness – Lana Del Rey', 'url': 'assets/Sad/Summertime Sadness.mp3'},
    {'title': 'Dandelions – Ruth B.', 'url': 'assets/Sad/Dandelions.mp3'},
    {'title': 'Night Changes – One Direction', 'url': 'assets/Sad/Night changes.mp3'},
    {'title': 'Runaway – Aurora', 'url': 'assets/Sad/Runaway.mp3'},
    {'title': 'Without Me – Halsey', 'url': 'assets/Sad/Without me.mp3'},
    {'title': 'Older – Sasha Alex Sloan', 'url': 'assets/Sad/Older.mp3'},
    {'title': 'Little Do You Know – Alex & Sierra', 'url': 'assets/Sad/Little do you know.mp3'},
    {'title': 'Heartbreak Anniversary – Giveon', 'url': 'assets/Sad/Heartbreak Anniversary.mp3'},
    {'title': 'Rewrite the Stars – Anne-Marie & James Arthur', 'url': 'assets/Sad/Rewrite the stars.mp3'},
    {'title': 'I Hate U, I Love U – gnash feat. Olivia O\'Brien', 'url': 'assets/Sad/I hate u i love you.mp3'},
    {'title': 'Ocean Eyes – Billie Eilish', 'url': 'assets/Sad/Ocean eyes.mp3'},
    {'title': 'You Broke Me First – Tate McRae', 'url': 'assets/Sad/you broke me first.mp3'},
    {'title': 'Lose You to Love Me – Selena Gomez', 'url': 'assets/Sad/lose you to love me.mp3'},
    {'title': 'Treat You Better – Shawn Mendes', 'url': 'assets/Sad/treat you better.mp3'},
    {'title': 'A Thousand Years – Christina Perri', 'url': 'assets/Sad/A thousand years.mp3'},
    {'title': 'Daylight – David Kushner', 'url': 'assets/Sad/Daylight.mp3'},
    {'title': 'Raanjhan – Sachet–Parampara & Jasleen Royal', 'url': 'assets/Sad/Raanjhana.mp3'},
    {'title': 'Na Ja Tu – Dhvani Bhanushali', 'url': 'assets/Sad/Na ja tu.mp3'},
    {'title': 'Husn – Anuv Jain', 'url': 'assets/Sad/Husn.mp3'},
  ],
  'Fresh Vibes': [
    {'title': 'That\'s So True – Gracie Abrams', 'url': 'assets/Fresh/That\'s so true.mp3'},
    {'title': 'Dream – Lisa', 'url': 'assets/Fresh/Dream.mp3'},
    {'title': 'Never Be the Same – Camila Cabello', 'url': 'assets/Fresh/Never be the same.mp3'},
    {'title': 'Daylight – Taylor Swift', 'url': 'assets/Fresh/Daylight.mp3'},
    {'title': 'Who Says – Selena Gomez & The Scene', 'url': 'assets/Fresh/Who says.mp3'},
    {'title': 'Pretty Girl – Maggie Lindemann', 'url': 'assets/Fresh/Pretty girl.mp3'},
    {'title': 'Pretty\'s on the Inside – Chloe Adams', 'url': 'assets/Fresh/Pretty\'s on the inside.mp3'},
    {'title': 'Labour – Paris Paloma', 'url': 'assets/Fresh/Labour.mp3'},
    {'title': 'Blank Space – Taylor Swift', 'url': 'assets/Fresh/Blank Space.mp3'},
    {'title': 'Like My Father – Jax', 'url': 'assets/Fresh/Like my father.mp3'},
    {'title': 'Lover – Taylor Swift', 'url': 'assets/Fresh/Lover.mp3'},
    {'title': 'Maria – Hwasa', 'url': 'assets/Fresh/Maria.mp3'},
    {'title': 'Love You Like a Love Song – Selena Gomez & The Scene', 'url': 'assets/Fresh/Love you like a love song.mp3'},
    {'title': 'Black Magic – Little Mix', 'url': 'assets/Fresh/Black magic.mp3'},
    {'title': 'What Makes You Beautiful – One Direction', 'url': 'assets/Fresh/What makes you beautiful.mp3'},
    {'title': 'Cardigan – Taylor Swift', 'url': 'assets/Fresh/Cardigan.mp3'},
    {'title': 'Blue – Yung Kai', 'url': 'assets/Fresh/Blue.mp3'},
    {'title': 'Finding Her – Tanishkaa Bahi', 'url': 'assets/Fresh/Finding her.mp3'},
    {'title': 'Golden Hour – JVKE', 'url': 'assets/Fresh/Golden hour.mp3'},
    {'title': 'Scars to Your Beautiful – Alessia Cara', 'url': 'assets/Fresh/Scars to your beautiful.mp3'},
    {'title': 'Obsessed – Mariah Carey', 'url': 'assets/Fresh/Obsessed.mp3'},
    {'title': 'Long Way to Go – Cassie', 'url': 'assets/Fresh/Long way 2 go.mp3'},
    {'title': 'I Am the Best – 2NE1', 'url': 'assets/Fresh/I am the best.mp3'},
    {'title': '10 Minutes – Lee Hyori', 'url': 'assets/Fresh/10 minutes.mp3'},
    {'title': 'Some – BOL4 (Bolbbalgan4)', 'url': 'assets/Fresh/some.mp3'},
  ],
  'Custom Playlist': [
